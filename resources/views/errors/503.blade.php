...
<head>
    ...
    <title>Pemeliharaan Sistem | JUKUNG BULIK</title>
...
<body class="bg-[#0a0a0c] text-slate-100 min-h-screen flex items-center justify-center p-4 antialiased selection:bg-amber-500 selection:text-black">
    ...
    <div class="w-full max-w-md mx-auto text-center">
        ...
        <div class="rounded-2xl border border-amber-500/20 bg-slate-900/60 backdrop-blur-xl p-8 shadow-2xl shadow-black/80">
            <div class="mb-4 inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-3.5 py-1 text-xs font-semibold text-amber-400 tracking-wider uppercase">
                Pemeliharaan Sistem
            </div>

            <h1 class="font-serif text-2xl font-bold text-slate-100 mb-3">Sistem Dalam Pemeliharaan</h1>
            
            <p class="text-sm text-slate-400 leading-relaxed mb-8">
                Layanan Jukung Bulik saat ini sedang menjalani pemeliharaan berkala untuk peningkatan performa. Sistem akan segera kembali aktif.
            </p>
            ...
            <div class="pt-6 border-t border-slate-800">
                <p class="text-xs text-slate-500 font-medium mb-3 uppercase tracking-wider">Pertanyaan & Informasi: Hubungi Panitia</p>
