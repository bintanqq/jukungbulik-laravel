...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | JUKUNG BULIK</title>
...
<body class="bg-[#0a0a0c] text-slate-100 min-h-screen flex items-center justify-center p-4 antialiased selection:bg-amber-500 selection:text-black">
    ...
    <div class="w-full max-w-md mx-auto text-center">
        ...
        <div class="rounded-2xl border border-amber-500/20 bg-slate-900/60 backdrop-blur-xl p-8 shadow-2xl shadow-black/80">
            <span class="block font-mono text-6xl font-extrabold text-amber-400 mb-2 tracking-tight">404</span>
            <h1 class="font-serif text-2xl font-bold text-slate-100 mb-3">Halaman Tidak Ditemukan</h1>
            
            <p class="text-sm text-slate-400 leading-relaxed mb-8">
                Tautan yang Anda tuju mungkin salah, telah dipindahkan, atau tidak lagi tersedia pada sistem Jukung Bulik.
            </p>
            ...
            <div class="pt-6 border-t border-slate-800">
                <p class="text-xs text-slate-500 font-medium mb-3 uppercase tracking-wider">Butuh Bantuan? Hubungi Panitia</p>
